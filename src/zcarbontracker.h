...
#ifndef CarbonZero_ZBTZTRACKER_H
#define CarbonZero_ZBTZTRACKER_H
...
public:
    CzcarbonTracker(std::string strWalletFile);
    ~CzcarbonTracker();
...
#endif //CarbonZero_ZBTZTRACKER_H
