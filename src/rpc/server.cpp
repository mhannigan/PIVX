...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop CarbonZero server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "CarbonZero server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CarbonZero features */
        {"carbonzero", "masternode", &masternode, true, true, false},
        {"carbonzero", "listmasternodes", &listmasternodes, true, true, false},
        {"carbonzero", "getmasternodecount", &getmasternodecount, true, true, false},
        {"carbonzero", "masternodeconnect", &masternodeconnect, true, true, false},
        {"carbonzero", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"carbonzero", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"carbonzero", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"carbonzero", "masternodecurrent", &masternodecurrent, true, true, false},
        {"carbonzero", "masternodedebug", &masternodedebug, true, true, false},
        {"carbonzero", "startmasternode", &startmasternode, true, true, false},
        {"carbonzero", "createmasternodekey", &createmasternodekey, true, true, false},
        {"carbonzero", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"carbonzero", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"carbonzero", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"carbonzero", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"carbonzero", "getmasternodescores", &getmasternodescores, true, true, false},
        {"carbonzero", "mnbudget", &mnbudget, true, true, false},
        {"carbonzero", "preparebudget", &preparebudget, true, true, false},
        {"carbonzero", "submitbudget", &submitbudget, true, true, false},
        {"carbonzero", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"carbonzero", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"carbonzero", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"carbonzero", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"carbonzero", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"carbonzero", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"carbonzero", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"carbonzero", "checkbudgets", &checkbudgets, true, true, false},
        {"carbonzero", "mnsync", &mnsync, true, true, false},
        {"carbonzero", "spork", &spork, true, true, false},
        {"carbonzero", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzcarbonseed", &getzcarbonseed, false, false, true},
        {"zerocoin", "setzcarbonseed", &setzcarbonseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzcarbon", &searchdzcarbon, false, false, true},
        {"zerocoin", "dzcarbonstate", &dzcarbonstate, false, false, true}
...
{
    return "> carbonzero-cli " + methodname + " " + args + "\n";
}
